...
- [[#configure-all-the-emacs][Configure all the Emacs!]]
  ...
  - [[#general-configs][General configs]]
    ...
    - [[#no-scrollbar-toolbar-menubar-because-bloat-1][No scrollbar, toolbar, menubar, because bloat]]
    - [[#line-numbers--relative-line-numbers-1][Line numbers + relative line numbers]]
    - [[#display-battery-in-the-bar-1][Display battery in the bar]]
    - [[#display-time-in-the-bar-1][Display time in the bar]]
    - [[#use-spaces-instead-of-tabs-1][Use spaces instead of tabs]]
    - [[#commenting-1][Commenting]]
    - [[#command-log-mode-1][Command log mode]]
    - [[#which-key-1][Which-key]]
    - [[#undo-magic-1][Undo magic]]
    - [[#buffer-display-1][Buffer display]]
    - [[#delete-unnecessary-whitespace-1][Delete unnecessary whitespace]]
    - [[#restart-emacs-from-within-emacs-1][Restart emacs from within emacs]]
    - [[#better-yesno-prompts-1][Better yes/no prompts]]
    - [[#show-the-column-number-1][Show the column number]]
    - [[#auto-fill-and-visual-fill-1][Auto Fill and Visual fill]]
      - [[#visual-fill-eg-the-visual-wrap-of-the-lines-1][Visual fill, e.g. the visual wrap of the lines]]
      - [[#auto-fill-eg-adding-line-breaks-to-lines-1][Auto fill, e.g. adding line breaks to lines]]
    - [[#highlight-current-line-1][Highlight current line]]
  - [[#keybindings][Keybindings]]
  - [[#modeline][Modeline]]
  - [[#dashboard][Dashboard]]
  - [[#evil-mode][Evil-mode]]
    - [[#evil-mode-configs][Evil mode configs]]
    - [[#evil-visual-line-mode-better][Evil visual line mode (better?)]]
